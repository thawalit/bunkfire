...
ui.setup_page("สถิติบั้งไฟ BANHAOSTATION", "🚀")
...
# ครอบด้วย container key=metric_row เพื่อให้ CSS มือถือจัดเป็น 2 ช่องต่อแถว (ดู app/ui.py)
with st.container(key="metric_row"):
    ...
    # ตัดวินาที/timezone ออก — ค่าเต็มยาวจนตกขอบบนจอมือถือ
    col4.metric("Scrape ล่าสุด", last_scrape[:16] if last_scrape else "ยังไม่เคยรัน")
